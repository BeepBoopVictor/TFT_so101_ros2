...
class HERCritic(torch.nn.Module):
    ...
    def __init__(self, action_shape, device='cpu'):
        ...
        # Recibe:
        #   - 10 (estado: 6Dof + 3 posicion pinza + 1 Color) + 3 (meta: x,y,z cubo rojo) + 6 (acciones) = 19 entradas
        # Salida:
        #   - 1 valor Q para la acción dada el estado y la meta
        self.net = torch.nn.Sequential(
            # torch.nn.Linear(16 + action_dim, 256),
            torch.nn.Linear(13 + action_dim, 256),
...
class HERFeatureNet(torch.nn.Module):
    ...
    def __init__(self, device='cpu'):
        ...
        # Red neuronal simple para el crítico.
        # Recibe:
        #   - 13 (estado: 6Dof + 3 posicion pinza + 3 posicion del cubo + 1 Color) + 3 (meta: x,y,z cubo rojo) = 16 entradas
        # Salida:
...
def main():
    ...
    #    - Horizon: longitud máxima de un episodio (200 pasos).
